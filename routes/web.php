...
//Route::resource('qrpunch', PunchController::class);
 ...
 Route::group(['middleware' => ['web', 'auth', 'permission'] ], function () {
        ...
        Route::get('user/{user}/deactivate', ['uses' => 'UserController@deactivate', 'as' => 'user.deactivate']);
          ...
          Route::get('timeuser', ['uses' => 'PunchController@indextime']);
         // Route::get('userpresence', ['uses' => 'PunchController@indexuserPresence']);
         Route::get('edit-time', ['uses' => 'PunchController@indexedit']);
